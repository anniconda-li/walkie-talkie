...
#define AI_INTERCOM_BTN_Y    206
#define AI_INTERCOM_BTN_SIZE 44
...
lv_obj_t * ui_app_ai_create(lv_obj_t * parent)
{
    ...
    g_ai_view.intercom_button = lv_button_create(root);
    lv_obj_set_pos(g_ai_view.intercom_button, AI_INTERCOM_BTN_X, AI_INTERCOM_BTN_Y);
    lv_obj_set_size(g_ai_view.intercom_button, AI_INTERCOM_BTN_SIZE, AI_INTERCOM_BTN_SIZE);
    lv_obj_set_style_radius(g_ai_view.intercom_button, LV_RADIUS_CIRCLE, 0);
    lv_obj_set_style_bg_color(g_ai_view.intercom_button, UI_COLOR_INTERCOM, 0);
    lv_obj_set_style_bg_color(g_ai_view.intercom_button,
                              lv_color_hex(0xCC4F00),
                              LV_STATE_PRESSED);
    lv_obj_set_style_border_width(g_ai_view.intercom_button, 0, 0);
    lv_obj_set_style_shadow_width(g_ai_view.intercom_button, 0, 0);
    lv_obj_add_flag(g_ai_view.intercom_button, LV_OBJ_FLAG_HIDDEN);

    g_ai_view.intercom_label = lv_label_create(g_ai_view.intercom_button);
    lv_label_set_text(g_ai_view.intercom_label, LV_SYMBOL_VOLUME_MAX);
    lv_obj_set_style_text_color(g_ai_view.intercom_label, lv_color_white(), 0);
    lv_obj_set_style_text_font(g_ai_view.intercom_label, ui_font_normal(), 0);
    lv_obj_center(g_ai_view.intercom_label);
    lv_obj_remove_flag(g_ai_view.intercom_label, LV_OBJ_FLAG_CLICKABLE);
...
void ui_app_ai_enter(lv_obj_t * root)
{
    ...
    lv_obj_set_y(g_ai_view.intercom_button, AI_INTERCOM_BTN_Y);
