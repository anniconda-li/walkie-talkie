 ...
 */
#define WDRIVER_AUDIO_MCLK_IO GPIO_NUM_6 /**< MCLK。 */
#define WDRIVER_AUDIO_BCLK_IO GPIO_NUM_7 /**< SCLK/BCLK。 */
#define WDRIVER_AUDIO_LRCK_IO GPIO_NUM_8 /**< LRCK/WS。 */
#define WDRIVER_AUDIO_DOUT_IO GPIO_NUM_16 /**< ESP 输出到 ES8311 DSDIN。 */
#define WDRIVER_AUDIO_DIN_IO  GPIO_NUM_9 /**< ES7210 SDOUT1 输入到 ESP。 */

/**
 * @brief ML307C/UART1 串口引脚定义。
 */
#define WDRIVER_UART_TX_IO      GPIO_NUM_21        /**< ESP TX -> ML307C RX。 */
#define WDRIVER_UART_RX_IO      GPIO_NUM_20        /**< ESP RX <- ML307C TX。 */
