 ...
 * @brief LCD 水平分辨率。
 */
#define d_lcd_H_RES 240u

/**
 * @brief LCD 垂直分辨率。
 */
#define d_lcd_V_RES 320u
 ...
 */
#define d_lcd_SWAP_XY  0
#define d_lcd_MIRROR_X 0
#define d_lcd_MIRROR_Y 0

/**
 * @brief 触摸控制器最大触点数。
 */
#define d_lcd_TOUCH_MAX_POINTS 2u
