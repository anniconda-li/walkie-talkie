...
#if SERVICE_INIT_NETWORK_BACKEND == SERVICE_INIT_NETWORK_BACKEND_ML307C
...
#if SERVICE_INIT_NETWORK_BACKEND == SERVICE_INIT_NETWORK_BACKEND_WIFI
...
{
    driver_init_config_t cfg = {
        .network_backend = SERVICE_INIT_NETWORK_BACKEND,
        .audio_input_backend = SERVICE_INIT_AUDIO_INPUT_BACKEND,
        .audio_output_backend = SERVICE_INIT_AUDIO_OUTPUT_BACKEND,
        .wifi_ssid = SERVICE_INIT_WIFI_SSID,
        .wifi_password = SERVICE_INIT_WIFI_PASSWORD,
    };
...
int service_init(void)
{
    ...
    service_audio_config_t audio_cfg = {
        .capture_ops = {
#if SERVICE_INIT_AUDIO_INPUT_BACKEND == SERVICE_INIT_AUDIO_INPUT_INMP441
        ...
        .playback_ops = {
#if SERVICE_INIT_AUDIO_OUTPUT_BACKEND == SERVICE_INIT_AUDIO_OUTPUT_MAX98357A
    ...
    ret = service_network_init(&network_cfg);
    if (ret != 0) {
